	...
	return (
		<nav className={`fixed w-full z-50 transition-all duration-300 bg-white ${scrolled ? " shadow-md py-3" : "bg-transparent py-5"}`}>
			<div className="container mx-auto px-6 flex justify-between items-center">
				...
				{/* Mobile Menu Button */}
				<button id="open-menu" aria-label="open menu toggle" className="md:hidden text-gray-700" onClick={() => setIsMenuOpen(!isMenuOpen)}>
			...
			{isMenuOpen && (
				<div className="md:hidden bg-slate-50 shadow-xl absolute top-full left-0 w-full p-6 flex flex-col space-y-4 ">
